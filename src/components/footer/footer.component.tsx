...
export const Footer = () => {
    return (
        <footer className="relative z-10 bg-white pt-20 p-10 lg:pt-[120px] lg:p-20">
                    ...
                    <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
                        <div className="mb-10 w-full">
                            ...
                            <p className="text-body-color mb-7 text-base">
                                A Splash é a melhor opção para você aproveitar o
                                verão com a sua família.
                            </p>
